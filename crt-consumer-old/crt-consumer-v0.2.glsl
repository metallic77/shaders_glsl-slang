...
#pragma parameter CONVX "Convergence X" 0.6 -1.0 1.0 0.05
#pragma parameter CONVY "Convergence Y" -0.1 -1.0 1.0 0.05
...
#pragma parameter BRIGHTBOOST1 "Boost Dark" 1.25 0.0 2.0 0.05
...
vec3 saturation (vec3 Color)
{
    ...
    vec3 res = vec3(mix(greyScaleColor, Color, SATURATION));
    return res;
}
...
void main()
{
    ...
    color*=color;;
    float lum = dot(vec3(0.3,0.6,0.1),color);
